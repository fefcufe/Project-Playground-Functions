...
# Descrição
Esse projeto foi desenvolvido com o intuito praticar a linguagem JavaScript por meio do desenvolvimento de funções que cumprissem determinado objetivo.
...
### 1 - Crie uma função usando o operador && chamada compareTrue

Desenvolva uma função ue receba dois parametros booleanos 
e:
 - Retornar `true` se ambos os valores forem verdadeiros;
 - Retornar `false` se um ou ambos os parâmetros forem falsos.
 A função deve somente utilizar o operador `&&`. 
